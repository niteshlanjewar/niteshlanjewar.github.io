      ...
      <div className="w-full py-20 border-b-[1px] border-b-black" >
        ...
        <div className="flex flex-col md:flex-col lg:flex-row 2xl:flex-row" >
          ...
          <Box m={'auto'} width={{ base: "100%", md: "45%" }}  mb={'20px'} id="user-detail-intro"  >
             <Text mb={'10px'}>I'm Nitesh Lanjewar, a passionate Full Stack Web Developer from Nagpur, Maharashtra with a strong background in the MERN stack. I have learned Full Stack Web Development at Masai School and have become proficient in problem-solving and executing software tasks from start to finish.</Text>
