    ...
    <div  className="w-full lgl:w-1/2 flex flex-col gap-20">
      <div className="flex flex-col gap-5">
        ...
        <h1 className="text-6xl font-bold text-white">
          Hi, I'm <span id="user-detail-name"  className="text-designColor capitalize">Nitesh Lanjewar</span>
        </h1>
      ...
      <div className="flex flex-col xl:flex-row gap-6 lgl:gap-0 justify-between">
        <div>
          ...
          <div className="flex gap-4">
              <a href={'https://github.com/niteshlanjewar'}  id="contact-github" target="_blank" >
            <span className="bannerIcon">
              <FaGithub/>
            </span>
              </a>
              <a href='https://www.linkedin.com/in/nitesh-lanjewar-688367234/' id="contact-linkedin" target='_blank' >

            <span className="bannerIcon" >
              <FaLinkedinIn />
            </span>
              </a>
              <a href='tel:9168679133' target='_blank' id="contact-phone">
            <span className="bannerIcon"  >
              <FaPhone />
            </span>
              </a>
              <a href='mailto:nitlanjewar1621@gmail.com' id="contact-email" target='_blank'>
            <span className="bannerIcon"  >
              <MdEmail/>
            </span>
                </a>
