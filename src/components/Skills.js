    ...
    <section id="skills" className="w-full py-20 border-b-[1px] border-b-black">
      ...
      <div>
        <Box w={'100%'} alignItems={'center'}>
          ...
          <GitHubCalendar class="react-activity-calendar" style={{ margin: 'auto' }} username="niteshlanjewar" />
        </Box>
        <SimpleGrid display={'flex'} flexWrap={'wrap'} gap={'10px'}>
          <Image id="github-streak-stats" margin={'auto'} src='https://github-readme-streak-stats.herokuapp.com?user=niteshlanjewar&theme=react' />
          <Image id="github-top-langs" margin={'auto'} src='https://github-readme-stats.vercel.app/api/top-langs/?username=niteshlanjewar&langs_count=8' />
          <Image id="github-stats-card" margin={'auto'} src='https://github-readme-stats.vercel.app/api?username=niteshlanjewar' />
        </SimpleGrid>
      </div>
    </section>
  );
